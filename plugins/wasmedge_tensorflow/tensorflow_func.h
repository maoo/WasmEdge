...
public:
  ...
  Expect<uint32_t> body(const Runtime::CallingFrame &CallFrame,
                        uint32_t SessionId, uint32_t NamePtr, uint32_t NameLen,
...
public:
  ...
  Expect<uint32_t> body(const Runtime::CallingFrame &CallFrame,
                        uint32_t SessionId, uint32_t TensorId, uint32_t LenPtr);
};
...
public:
  ...
  Expect<uint32_t> body(const Runtime::CallingFrame &CallFrame,
                        uint32_t SessionId, uint32_t TensorId, uint32_t BufPtr,
                        uint32_t BufLen, uint32_t WrittenBytesPtr);
};
